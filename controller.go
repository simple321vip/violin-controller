...
import (
	...
	samplev1alpha1 "violin-controller/pkg/apis/violincontroller/v1"
...
func (c *Controller) updateFooStatus(foo *samplev1alpha1.Foo, deployment *appsv1.Deployment) error {
	...
	_, err := c.sampleclientset.ViolincontrollerV1().Foos(foo.Namespace).UpdateStatus(context.TODO(), fooCopy, metav1.UpdateOptions{})
	return err
}
